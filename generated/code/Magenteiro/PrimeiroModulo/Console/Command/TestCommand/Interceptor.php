<?php
namespace Magenteiro\PrimeiroModulo\Console\Command\TestCommand;

/**
 * Interceptor class for @see \Magenteiro\PrimeiroModulo\Console\Command\TestCommand
 */
class Interceptor extends \Magenteiro\PrimeiroModulo\Console\Command\TestCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'formatText');
        return $pluginInfo ? $this->___callPlugins('formatText', func_get_args(), $pluginInfo) : parent::formatText($prefix, $suffix);
    }
